...
+ 公钥算法分类：基于数论函数
  ...
  安全等级（与对称密码比较）：<img src="https://cdn.jsdelivr.net/gh/zweix123/CS-notes@master/source/Math/Cryptology/公钥密码等级.jpg" style="zoom:60%;" />
...
+ 定义：![](https://cdn.jsdelivr.net/gh/zweix123/CS-notes@master/source/Math/Cryptology/群.jpg)
  + 操作符为乘法即为乘法群，操作符为加法即为加法群

+ 重要的群：乘法群==？==：$\mathbb{Z}^{*}_n$：

  ![](https://cdn.jsdelivr.net/gh/zweix123/CS-notes@master/source/Math/Cryptology/重要的群.jpg)

+ 有限群：![](https://cdn.jsdelivr.net/gh/zweix123/CS-notes@master/source/Math/Cryptology/有限群.jpg)

+ 元素的阶：![](https://cdn.jsdelivr.net/gh/zweix123/CS-notes@master/source/Math/Cryptology/元素的阶.jpg)
