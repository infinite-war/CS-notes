...
## 启动器Cerebro
>[lnk](https://github.com/cerebroapp/cerebro)  



启动器这类软件我之前没有接触过，可能Mac用户接触的更多，因缘际会下知道Alfred，想找有没有跨平台开源的启动器软件，在Chatgpt的介绍下先选择体验下Cerebro
[github]()

目前主要使用的功能有
+ 键入网址打开对应网页：主要用于bilibili
+ 翻译：自带的translate只能其他翻译英文，我用的youdao
+ 打开文件
	+ 我的文件很少，直接键入路径，有补全，但是如果路径有中文好像是打不开
	+ 通过补全找到软件后在Home使用shell
+ 简单命令
	+ 比如code，找到文件后Home再`$code`打开项目，算是节省了wt这一步，也还行。
