+ 定义：a group of computers cooperating to provide a service (this class is mostly about infrastructure services) 通过网络协调、共同完成一致任务的多台物理隔离的计算机，比如存储系统、大数据运算或者点对点文件共享。
